#!/usr/bin/env python3
"""
NFX Signal - Fintech Seed URL Collector via GraphQL API
========================================================
Queries signal-api.nfx.com/graphql for the fintech-seed list.
...
def main():
    log.info("=" * 60)
    log.info("  NFX SIGNAL - FINTECH SEED URL COLLECTOR")
